...
import { JobsPlugin, getJobsAPI } from '../src/plugin.js';
...
describe('Jobs Plugin', () => {
  ...
  describe('Plugin Lifecycle', () => {
    ...
    it('should start successfully', async () => {
      ...
      expect(mockContext.logger.info).toHaveBeenCalledWith(expect.stringContaining('Started'));
    });
  ...
  describe('Event Integration', () => {
    ...
    it('should emit job lifecycle events', async () => {
      ...
      expect(mockContext.trigger).toHaveBeenCalledWith('job.enqueued', expect.any(Object));
    });
  });
});
