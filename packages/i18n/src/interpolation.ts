 ...
 */
export function pluralize(translations: any, params: PluralizationOptions): string {
 ...
 */
export function formatDate(value: Date, locale: string, options?: DateFormatOptions): string {
  try {
