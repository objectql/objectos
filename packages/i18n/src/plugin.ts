...
export class I18nPlugin implements Plugin, II18nService {
  ...
  t(
    key: string,
    localeOrParams?: string | InterpolationOptions | Record<string, unknown>,
        ...
        provides: [
          {
            ...
            methods: [
              {
                name: 'translate',
                description: 'Translate a key to the target locale',
                async: false,
                returnType: 'string',
              },
              ...
              },
              {
                ...
                description: 'Load translations for a locale',
                async: true,
              },
            ],
            stability: 'stable',
