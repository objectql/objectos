...
export function validateScript(script: string): string[] {
  ...
  const dangerous = [
    {
      pattern: /\brequire\s*\(/,
      message: 'Script uses require() — modules are not available in sandbox',
    },
    {
      pattern: /\bimport\s+/,
      message: 'Script uses import — modules are not available in sandbox',
    },
    ...
    { pattern: /\b__dirname\b/, message: 'Script references __dirname — not available in sandbox' },
    {
      ...
      message: 'Script references __filename — not available in sandbox',
    },
    ...
    {
      pattern: /\bFunction\s*\(/,
      message: 'Script uses Function constructor — potential security risk',
    },
  ];
