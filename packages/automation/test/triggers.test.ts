...
describe('TriggerEngine', () => {
  ...
  describe('Object Triggers - onCreate', () => {
    it('should fire onCreate trigger when object matches', () => {
      ...
      const result = engine.evaluateObjectTrigger(trigger, 'object.create', 'Contact', {
        id: '1',
        name: 'John Doe',
      });
    ...
    it('should not fire onCreate trigger when object does not match', () => {
      ...
      const result = engine.evaluateObjectTrigger(trigger, 'object.create', 'Account', {
        id: '1',
        name: 'ACME Corp',
      });
    ...
    it('should not fire onCreate trigger on update event', () => {
      ...
      const result = engine.evaluateObjectTrigger(trigger, 'object.update', 'Contact', {
        id: '1',
        name: 'John Doe',
      });
  ...
  describe('Object Triggers - onDelete', () => {
    it('should fire onDelete trigger when object matches', () => {
      ...
      const result = engine.evaluateObjectTrigger(trigger, 'object.delete', 'Contact', {
        id: '1',
        name: 'John Doe',
      });
  ...
  describe('Scheduled Triggers (Cron)', () => {
    it('should register a scheduled trigger', () => {
      ...
      expect(mockLogger.info).toHaveBeenCalledWith('Scheduled trigger registered for rule: rule-1');
    });
