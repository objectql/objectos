...
describe('SharingRuleEngine', () => {
    ...
    describe('Rule Management', () => {
        ...
        it('should sort rules by priority', () => {
            engine.addRule({
                name: 'low_priority', label: 'Low', objectName: 'orders',
                type: 'owner_based', sharedWithType: 'role', sharedWithValues: ['admin'],
                accessLevel: 'read_only', priority: 50,
            });
            engine.addRule({
                name: 'high_priority', label: 'High', objectName: 'orders',
                type: 'owner_based', sharedWithType: 'role', sharedWithValues: ['admin'],
                accessLevel: 'read_write', priority: 10,
            });
        ...
        it('should remove a rule by name', () => {
            engine.addRule({
                name: 'test_rule', label: 'Test', objectName: 'orders',
                type: 'owner_based', sharedWithType: 'role', sharedWithValues: ['admin'],
                accessLevel: 'read_only',
            });
        ...
        it('should get all rules across objects', () => {
            engine.addRule({
                name: 'rule1', label: 'Rule 1', objectName: 'orders',
                type: 'owner_based', sharedWithType: 'role', sharedWithValues: ['admin'],
                accessLevel: 'read_only',
            });
            engine.addRule({
                name: 'rule2', label: 'Rule 2', objectName: 'contacts',
                type: 'criteria_based', sharedWithType: 'group', sharedWithValues: ['sales_team'],
                accessLevel: 'read_write', criteria: { status: 'active' },
            });
    ...
    describe('Rule Evaluation', () => {
        it('should grant access for role-based sharing', () => {
            engine.addRule({
                name: 'share_orders', label: 'Share Orders', objectName: 'orders',
                type: 'owner_based', sharedWithType: 'role', sharedWithValues: ['sales_manager'],
                accessLevel: 'read_only',
        ...
        it('should grant access for group-based sharing', () => {
            engine.addRule({
                name: 'share_with_sales', label: 'Share with Sales', objectName: 'leads',
                type: 'criteria_based', sharedWithType: 'group', sharedWithValues: ['sales_team'],
        ...
        it('should pick highest access level from multiple matching rules', () => {
            engine.addRule({
                name: 'read_only_rule', label: 'Read', objectName: 'orders',
                type: 'owner_based', sharedWithType: 'role', sharedWithValues: ['manager'],
                accessLevel: 'read_only', priority: 20,
            });
            engine.addRule({
                name: 'read_write_rule', label: 'Write', objectName: 'orders',
                type: 'criteria_based', sharedWithType: 'role', sharedWithValues: ['manager'],
                accessLevel: 'read_write', priority: 10,
                criteria: { region: 'US' },
            });
        ...
        it('should skip inactive rules', () => {
            engine.addRule({
                name: 'inactive_rule', label: 'Inactive', objectName: 'orders',
                type: 'owner_based', sharedWithType: 'role', sharedWithValues: ['admin'],
                accessLevel: 'read_write', isActive: false,
            });
        ...
        it('should handle territory-based sharing', () => {
            engine.addRule({
                name: 'territory_share', label: 'Territory', objectName: 'accounts',
                type: 'owner_based', sharedWithType: 'territory', sharedWithValues: ['west_coast'],
                accessLevel: 'read_write',
            });
        ...
        it('should build owner-based filters in result', () => {
            engine.addRule({
                name: 'owner_rule', label: 'Owner', objectName: 'orders',
                type: 'owner_based', sharedWithType: 'role', sharedWithValues: ['manager'],
                accessLevel: 'read_only',
        ...
        it('should build criteria-based filters in result', () => {
            engine.addRule({
                name: 'criteria_rule', label: 'Criteria', objectName: 'orders',
                type: 'criteria_based', sharedWithType: 'role', sharedWithValues: ['manager'],
                accessLevel: 'read_only',
    ...
    describe('Role Hierarchy Support', () => {
        it('should grant access via role_and_subordinates with hierarchy path', () => {
            engine.addRule({
                name: 'hierarchy_rule', label: 'Hierarchy', objectName: 'orders',
                type: 'owner_based', sharedWithType: 'role_and_subordinates',
