...
export { MetricsPlugin, getMetricsAPI } from './plugin.js';

export { CounterCollector, GaugeCollector, HistogramCollector } from './collectors.js';

export { exportPrometheus, parsePrometheusLine } from './prometheus.js';

export { aggregateHealth, isSystemOperational } from './health.js';

export type { SystemHealthReport } from './health.js';
