...
export class FormulaEngine {
     ...
     */
    setQueryRecordsHandler(
        handler: (objectName: string, filter: any) => Promise<any[]>
    ): void {
     ...
     */
    private calculateCalculatedField(
        config: CalculatedFormulaConfig,
        record: any
    ): any {
        try {
    ...
    private async calculateRollupField(
        ...
        try {
            ...
            return this.performRollupOperation(
                config.operation,
                relatedRecords,
     ...
     */
    private calculateAutoNumberField(
        config: AutoNumberFormulaConfig,
        formula: FormulaField
    ): string {
     ...
     */
    private performRollupOperation(
