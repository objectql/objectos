...
describe('ApprovalService', () => {
  ...
  describe('createApprovalChain', () => {
    it('should create multi-level approval tasks', async () => {
      ...
      const tasks = await approvalService.createApprovalChain('wf_1', chain, 'purchase_order');
    ...
    it('should support optional approval levels', async () => {
      ...
      const tasks = await approvalService.createApprovalChain('wf_1', chain, 'expense');
