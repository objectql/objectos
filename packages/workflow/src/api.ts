...
export class WorkflowAPI {
  ...
  async executeTransition(
    ...
    if (!definition) {
      throw new Error(`Workflow definition not found: ${instance.workflowId} v${instance.version}`);
    }
   ...
   * Complete a task
   */
  async completeTask(taskId: string, result?: Record<string, any>): Promise<WorkflowTask> {
