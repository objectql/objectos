      ...
      <main className="min-h-screen">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
            <div className="text-center space-y-8">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Instant Backend. Security Kernel. Workflow Automation. Built on{' '}
                <Link
                  href="https://github.com/objectstack-ai/objectql"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center space-y-6 mb-16">
              ...
              <p className="text-lg text-muted-foreground">
                ObjectOS is a production-ready, metadata-driven runtime platform. While{' '}
                <strong>ObjectQL</strong> defines <em>how data looks</em>, <strong>ObjectOS</strong>{' '}
                defines <em>how business runs</em>.
              </p>
              <p className="text-lg text-muted-foreground">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="p-6 rounded-xl border border-border bg-card">
                ...
                <p className="text-muted-foreground">
                  Intercepts every request to enforce RBAC (Role-Based Access Control) and
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong>Authentication:</strong> Integrated OIDC, SAML, and LDAP support
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-primary">•</span>
                    <span>
                      <strong>Fine-Grained Permission:</strong> Field-level and record-level sharing
                      rules
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-primary">•</span>
                    <span>
                      <strong>Audit Logging:</strong> Built-in tracking of who did what and when
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground mb-4">Stop writing boilerplate controllers.</p>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-start gap-2">
                    <span className="text-primary">•</span>
                    <span>
                      <strong>Auto-generated REST API:</strong> Works out-of-the-box
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-primary">•</span>
                    <span>
                      <strong>Auto-generated GraphQL:</strong> Instant schema stitching
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-primary">•</span>
                    <span>
                      <strong>Metadata API:</strong> Serves UI configuration to frontend clients
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-start gap-2">
                    <span className="text-primary">•</span>
                    <span>
                      <strong>Triggers:</strong> Run code beforeInsert, afterUpdate, beforeDelete
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-primary">•</span>
                    <span>
                      <strong>Flow Engine:</strong> Visual workflow execution (BPMN-style)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-primary">•</span>
                    <span>
                      <strong>Job Queue:</strong> Background task processing based on Redis
                    </span>
                  </li>
                </ul>
              </div>
              ...
              {[
                {
                  ...
                  role: 'The Brain',
                  desc: 'Core logic engine. Wraps ObjectQL, manages plugins, and handles the event bus.',
                },
                {
                  name: '@objectos/server',
                  role: 'The Gateway',
                  desc: 'NestJS application layer. Handles HTTP/WS traffic, Middlewares, and Guards.',
                },
                {
                  name: '@objectos/plugin-auth',
                  role: 'Auth',
                  desc: 'Authentication strategies (Local, OAuth2, Enterprise SSO).',
                },
                {
                  name: '@objectos/plugin-workflow',
                  role: 'Logic',
                  desc: 'Workflow engine and trigger runner.',
                },
                {
                  name: '@objectos/presets',
                  role: 'Config',
                  desc: 'Standard system objects (_users, _roles, _audit_log).',
                },
              ].map((pkg) => (
        ...
        <section className="py-24 bg-muted/30 border-t border-border">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
            <h2 className="text-3xl sm:text-4xl font-bold">Start Building with ObjectOS</h2>
            <p className="text-lg text-muted-foreground">
