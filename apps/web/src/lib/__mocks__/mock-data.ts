...
import type { AppDefinition, ObjectDefinition, RecordData } from '@/types/metadata';
...
export const mockRecords: Record<string, RecordData[]> = {
  ...
  opportunity: [
    ...
    {
      id: 'opp-002',
      name: 'HealthFirst Pilot',
      amount: 25000,
      stage: 'qualification',
      close_date: '2025-02-28T00:00:00Z',
      account_id: 'acc-003',
  ...
  payment: [
    {
      ...
      status: 'completed',
      payment_date: '2025-01-28T14:00:00Z',
      invoice_id: 'inv-001',
  ...
  task: [
    ...
    },
    {
      ...
      description: 'Run quarterly security audit',
