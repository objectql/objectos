...
export const LeadStateMachine: StateMachineConfig = {
  ...
  states: {
    new: {
      ...
      meta: {
        aiInstructions:
          'New lead. Verify email and phone before contacting. Do not change status until contact is made.',
      },
    },
    contacted: {
      on: {
      ...
      meta: {
        aiInstructions:
          'Engage with the lead. Qualify by asking about budget, authority, need, and timeline (BANT).',
      },
    },
    qualified: {
      on: {
      ...
      meta: {
        aiInstructions:
          'Lead is qualified. Prepare for conversion to Deal/Opportunity. Check for existing accounts.',
      },
    },
    unqualified: {
      on: {
