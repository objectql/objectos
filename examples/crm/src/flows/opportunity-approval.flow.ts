...
export const OpportunityApprovalFlow: Flow = {
  ...
  variables: [{ name: 'opportunityId', type: 'text', isInput: true, isOutput: false }],
  ...
  edges: [
    ...
    { id: 'e3', source: 'approval_step_manager', target: 'decision_manager', type: 'default' },
    {
      ...
      target: 'approval_step_director',
      type: 'default',
      condition: '{approval_step_manager.result} == "approved"',
      label: 'Approved',
    },
    {
      id: 'e5',
      source: 'decision_manager',
      target: 'notify_rejection',
      type: 'default',
      condition: '{approval_step_manager.result} != "approved"',
      label: 'Rejected',
    },
    { id: 'e6', source: 'approval_step_director', target: 'decision_director', type: 'default' },
    {
      ...
      target: 'mark_approved',
      type: 'default',
      condition: '{approval_step_director.result} == "approved"',
      label: 'Approved',
    },
    {
      id: 'e8',
