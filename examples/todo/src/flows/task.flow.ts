  ...
  nodes: [
    {
      id: 'start',
      type: 'start',
      label: 'Start (Daily 8 AM)',
      config: { schedule: '0 8 * * *', objectName: 'task' },
    },
    {
...
export const OverdueEscalationFlow: Flow = {
  ...
  variables: [{ name: 'overdueTasks', type: 'record_collection', isInput: false, isOutput: false }],

  nodes: [
    {
      id: 'start',
      type: 'start',
      label: 'Start (Daily 9 AM)',
      config: { schedule: '0 9 * * *', objectName: 'task' },
    },
    {
...
export const TaskCompletionFlow: Flow = {
    ...
    },
    {
      ...
      config: {
        ...
        fields: {
          ...
          due_date:
            'DATEADD({completedTask.due_date}, {completedTask.recurrence_interval}, "{completedTask.recurrence_type}")',
          status: 'not_started',
          is_completed: false,
        },
  ...
  edges: [
    ...
    {
      id: 'e3',
      source: 'check_recurring',
      target: 'create_next_task',
      type: 'default',
